...
class Exporter(SchemaSelectorMixin):
    ...
    def __init__(self, project):
        ...
        self.schema_attrs = self.get_attributes(self.project)
        ...
        self.metadata = {
            'location': {
                ...
                'content_type': get_content_type(app_label='spatial',
                                                 model='spatialunit'),
                'schema_attrs': self.schema_attrs['spatial.spatialunit'],
            ...
            'party': {
                ...
                'content_type': get_content_type(app_label='party',
                                                 model='party'),
                'schema_attrs': self.schema_attrs['party.party'],
            ...
            'tenure_rel': {
                ...
                'schema_attrs': self.schema_attrs['party.tenurerelationship'],
    ...
    def process_entity(self, type_line, source_line, write_callback):
