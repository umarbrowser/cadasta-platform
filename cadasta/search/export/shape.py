...
class ShapeExporter(Exporter):
    ...
    def __init__(self, project, has_csv):
        self.has_csv = has_csv
    ...
    def make_download(self, es_dump_path):
        ...
        self.shp_datasource = self.create_shp_datasource(self.dir_path)
